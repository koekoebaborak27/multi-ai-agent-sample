...
| **お知らせ管理機能（設計1＋実装9＋テスト仕様書1＋テスト実施1）**                          | **6 / 12**  |
| **公開用テンプレートの切り出し**                                            | **0 / 8**   |
...
**次のセッションでは、[お知らせ管理機能](#お知らせ管理機能) の実装工程7（お知らせ管理一覧の検索・並び替え。`NewsSearchForm`・`NewsTable`・`SortableTableHead`・公開ステータス判定）に着手する**（工程6のお知らせ管理画面の土台は2026-08-25に完了済み。→ [履歴](history/2026-08-w4.md#2026-08-25-お知らせ管理機能のお知らせ管理画面の土台工程6を完了)）。[公開用テンプレートの切り出し](#公開用テンプレートの切り出し)（2026-08-23 に方針を確定済み。→ [履歴](history/2026-08-w3.md#2026-08-23-公開用テンプレートの切り出し方針を確定)）は、この後に着手する。
...
ダッシュボード（トップ画面）に表示する「お知らせ」を、`ADMIN`・`OPERATOR`が自分たちで登録・更新・削除できるようにする。マスタ機能の進め方（設計→製造→単体テスト）に倣う。要件定義は2026-08-24に1問1答形式で確定し、同日の基本設計時の壁打ちで一部を上書きした（→ [要件定義](../specs/01_requirements/news/01_お知らせ管理.md)、[設計書](../specs/02_basic-design/news/README.md)）。

- [x] 1. **基本設計書を作成する**（2026-08-24）→ [履歴](history/2026-08-w4.md#2026-08-24-お知らせ管理機能の基本設計書を作成)
- [x] 2. **DBスキーマを変更する**（2026-08-24）→ [履歴](history/2026-08-w4.md#2026-08-24-お知らせ管理機能のdbスキーマ変更工程2を完了)
- [x] 3. **モジュールをリネームし土台を実装する**（2026-08-24）→ [履歴](history/2026-08-w4.md#2026-08-24-お知らせ管理機能のモジュールリネームと土台実装工程3を完了)
- [x] 4. **トップ画面の表示を実装する**（2026-08-25）→ [履歴](history/2026-08-w4.md#2026-08-25-お知らせ管理機能のトップ画面表示工程4を完了)
- [x] 5. **トップ画面の「さらに表示」を実装する**（2026-08-25）→ [履歴](history/2026-08-w4.md#2026-08-25-お知らせ管理機能のトップ画面さらに表示工程5を完了)
- [x] 6. **お知らせ管理画面の土台を実装する**（2026-08-25）→ [履歴](history/2026-08-w4.md#2026-08-25-お知らせ管理機能のお知らせ管理画面の土台工程6を完了)
- [ ] 7. お知らせ管理一覧の検索・並び替えを実装する（`NewsSearchForm`・`NewsTable`・`SortableTableHead`・公開ステータス判定。→ [設計書§20](../specs/02_basic-design/news/20_お知らせ管理一覧.md)）
- [ ] 8. お知らせ登録を実装する（`NewsCreateDialog`・`NewsConfirmation`・登録Server Action。→ [設計書§21](../specs/02_basic-design/news/21_お知らせ登録.md)）
- [ ] 9. お知らせ更新を実装する（`NewsEditDialog`・楽観ロック・更新Server Action。→ [設計書§22](../specs/02_basic-design/news/22_お知らせ更新.md)）
- [ ] 10. お知らせ削除を実装する（`NewsDeleteDialog`・削除Server Action。→ [設計書§23](../specs/02_basic-design/news/23_お知らせ削除.md)）
- [ ] 11. 単体テスト仕様書を作成する
- [ ] 12. 単体テスト（画面操作テスト）を実施する
...
| 直近の検証 | 2026-08-25、お知らせ管理機能の工程6で`pnpm test -- src/modules/auth/route-guard.test.ts`（17件）・`pnpm lint`・`pnpm typecheck`・`pnpm format:check`が成功 |
