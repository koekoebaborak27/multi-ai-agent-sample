...
| **公開用テンプレートの切り出し前準備（ER図・画面遷移図・セキュリティテスト）**                     | **0 / 3**   |
| **公開用テンプレートの切り出し**                                            | **0 / 8**   |
...
**次のセッションは、[公開用テンプレートの切り出し前準備](#公開用テンプレートの切り出し前準備)の1番（draw.io で ER 図作成を検討する）から着手する。** 最初に `git status --porcelain` で未コミット差分を確認する。
...
- [ ] 1. draw.io で ER 図作成を検討する
- [ ] 2. draw.io で画面遷移図作成を検討する
- [ ] 3. セキュリティテストの仕様書を作り、テストする
