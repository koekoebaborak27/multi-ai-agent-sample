...
**次のセッションでは、[お知らせ管理機能](#お知らせ管理機能) の工程11（単体テスト仕様書の作成）に着手する**（工程10のお知らせ削除は2026-08-25に完了済み。→ [履歴](history/2026-08-w4.md#2026-08-25-お知らせ管理機能のお知らせ削除工程10を完了)）。最初に `git status --porcelain` で未コミット差分を確認する。[公開用テンプレートの切り出し](#公開用テンプレートの切り出し)（2026-08-23 に方針を確定済み。→ [履歴](history/2026-08-w3.md#2026-08-23-公開用テンプレートの切り出し方針を確定)）は、この後に着手する。
